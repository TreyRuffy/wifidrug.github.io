window.Modernizr = function(e, t, n) {
    ...
    var f, d, p = "2.7.1", m = {}, h = !0, g = t.documentElement, v = "modernizr", y = t.createElement(v), b = y.style, E = t.createElement("input"), x = ":)", w = {}.toString, S = " -webkit- -moz- -o- -ms- ".split(" "), C = "Webkit Moz O ms", k = C.split(" "), T = C.toLowerCase().split(" "), j = {
        svg: "http://www.w3.org/2000/svg"
    }, N = {}, P = {}, M = {}, A = [], D = A.slice, L = function(e, n, r, o) {
        ...
        l.appendChild(c);
        return a = '&#173;<style id="s' + v + '">' + e + "</style>", l.id = v, (u ? l : f).innerHTML += a, 
        f.appendChild(l), u || (f.style.background = "", f.style.overflow = "hidden", s = g.style.overflow, 
        g.style.overflow = "hidden", g.appendChild(f)), i = n(l, e), u ? l.parentNode.removeChild(l) : (f.parentNode.removeChild(f), 
        g.style.overflow = s), !!i;
    }, $ = function() {
        function e(e, o) {
    ...
    d = a(z, "undefined") || a(z.call, "undefined") ? function(e, t) {
        ...
        var n;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : L("@media (" + S.join("touch-enabled),(") + v + "){#modernizr{top:9px;position:absolute}}", function(e) {
            n = 9 === e.offsetTop;
        }), n;
        ...
        var e;
        return L("#" + v + "{font:0/0 a}#" + v + ':after{content:"' + x + '";visibility:hidden;font:3px/1 a}', function(t) {
            e = t.offsetHeight >= 3;
        }), e;
    }, N.video = function() {
    ...
    return m.input || u(), m.addTest = function(e, t) {
        if ("object" == typeof e) for (var r in e) d(e, r) && m.addTest(r, e[r]); else {
            ...
            t = "function" == typeof t ? t() : t, void 0 !== h && h && (g.className += " " + (t ? "" : "no-") + e), 
            m[e] = t;
        }
        return m;
        ...
        e.html5 = y, s(t);
    }(this, t), m._version = p, m._prefixes = S, m._domPrefixes = T, m._cssomPrefixes = k, 
    m.hasEvent = $, m.testProp = function(e) {
        return c([ e ]);
    }, m.testAllProps = l, m.testStyles = L, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + A.join(" ") : ""), 
    m;
    ...
    function s(e, n, r, o, a, s, l) {
        function u(t) {
            if (!p && i(f.readyState) && (b.r = p = 1, !y && c(), f.onload = f.onreadystatechange = null, 
            t)) {
                "img" != e && m(function() {
                    x.removeChild(f);
                }, 50);
        ...
        1 === T[n] && (g = 1, T[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), 
        f.width = f.height = "0", f.onerror = f.onload = f.onreadystatechange = function() {
            u.call(this, g);
        }, v.splice(o, 0, b), "img" != e && (g || 2 === T[n] ? (x.insertBefore(f, E ? null : h), 
        m(u, l)) : T[n].push(f));
    }
    function l(e, t, n, r, a) {
        return y = 0, t = t || "j", o(e) ? s("c" == t ? S : w, e, t, this.i++, n, r, a) : (v.splice(this.i++, 0, e), 
        1 == v.length && c()), this;
    }
    function u() {
        var e = d;
    ...
    var f, d, p = t.documentElement, m = e.setTimeout, h = t.getElementsByTagName("script")[0], g = {}.toString, v = [], y = 0, b = "MozAppearance" in p.style, E = b && !!t.createRange().compareNode, x = E ? p : h.parentNode, p = e.opera && "[object Opera]" == g.call(e.opera), p = !!t.attachEvent && !p, w = b ? "object" : p ? "script" : "img", S = p ? "script" : w, C = Array.isArray || function(e) {
    ...
    d = function(e) {
        ...
        function i(e, o, a, i, c) {
            ...
            s.url.split(".").pop().split("?").shift(), s.bypass || (o && (o = r(o) ? o : o[e] || o[i] || o[e.split("/").pop().split("?")[0]]), 
            s.instead ? s.instead(e, o, a, i, c) : (T[s.url] ? s.noexec = !0 : T[s.url] = 1, 
            a.load(s.url, s.forceCSS || !s.forceJS && "css" == s.url.split(".").pop().split("?").shift() ? "c" : n, s.noexec, s.attrs, s.timeout), 
            (r(o) || r(l)) && a.load(function() {
        ...
        if (o(e)) i(e, 0, f, 0); else if (C(e)) for (s = 0; s < e.length; s++) l = e[s], 
        o(l) ? i(l, 0, f, 0) : C(l) ? d(l) : Object(l) === l && c(l, f); else Object(e) === e && c(e, f);
    }, d.addPrefix = function(e, t) {
        j[e] = t;
    }, d.addFilter = function(e) {
        k.push(e);
    }, d.errorTimeout = 1e4, null == t.readyState && t.addEventListener && (t.readyState = "loading", 
